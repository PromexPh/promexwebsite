...
const certifications = [
  { name: 'DMW Licensed Recruitment Agency', issuer: 'Department of Migrant Workers', year: '1996 - Present', description: 'Official government license to operate as a private recruitment and placement agency in the Philippines, issued by the Department of Migrant Workers. Valid and active since 1996.', iconImage: '/images/icons/01.svg', badge: null, link: null },
  { name: 'ISO 9001:2015 Certified', issuer: 'International Organization for Standardization', year: '2018', description: 'International quality management standard certification ensuring our recruitment processes meet consistent, reliable, and globally recognized service standards across all operations.', iconImage: '/images/icons/02.svg', badge: null, link: null },
  { name: 'POEA Accreditation', issuer: 'Philippine Overseas Employment Administration', year: '1996 - Present', description: 'Accredited by the Philippine Overseas Employment Administration to recruit and deploy Filipino workers for legitimate overseas employment opportunities since 1996.', iconImage: '/images/icons/03.svg', badge: null, link: null },
  { name: 'Circle Test Assessment Center', issuer: 'TESDA Registered', year: '2012', description: 'TESDA-registered government training and assessment center for trade testing and skills certification, ensuring candidates meet international employer standards before deployment.', iconImage: '/images/icons/04.svg', badge: null, link: null },
  { name: 'OWWA Partner Agency', issuer: 'Overseas Workers Welfare Administration', year: '1996 - Present', description: 'Official partner of the Overseas Workers Welfare Administration, ensuring all deployed Filipino workers receive proper welfare support, protection, and assistance throughout their employment.', iconImage: '/images/icons/05.svg', badge: null, link: null },
